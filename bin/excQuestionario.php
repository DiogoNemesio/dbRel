...
if (empty($codQuestionario)) {
	DHCErro::halt('Falta de Parâmetros (COD_QUESTIONARIO) 2'); 
}else{
	$info			= questionario::getInfo($codQuestionario);
	$nome			= $info->NOME;
	$mensagem		= "Tem certeza que deseja excluir o Questionario ";
}
...
$template->assign('EXCTITLE'			,"Exclusão de Questionario");
