...
if (!isset($codPergunta)) {
	echo '1'.DHCUtil::encodeUrl('||'.'Falta de Parâmetros (COD_PERGUNTA)');
	exit;
}
...
## Excluir do banco
#################################################################################
$err	= pergunta::exclui($codPergunta);


if ($err == null) {
	echo '0'.DHCUtil::encodeUrl('|'.$codPergunta.'|Pergunta excluída com sucesso !!');
}else{
