 ...
 * @version: 1.0
 * 
 * Gerenciar páginas em PDF
 */

class DHCPDF extends Zend_Pdf {
	...
	private function _addHeader($i) {
		
	}
	
	private function _addFooter($i) {
